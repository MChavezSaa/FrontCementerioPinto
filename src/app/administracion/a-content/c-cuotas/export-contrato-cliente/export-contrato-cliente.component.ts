...
@Component({
  selector: 'app-export-contrato-cliente',
  templateUrl: './export-contrato-cliente.component.html',
  styleUrls: ['./export-contrato-cliente.component.css']
})
export class ExportContratoClienteComponent implements OnInit {
  ...
  constructor(public service: BackendServiceService,
    public router: Router, public activatedRoute: ActivatedRoute) { 
      ...
      this.contratoParams.cliente = new Cliente();
    }
    ...
    ngOnInit() {
      ...
      this.activatedRoute.params.subscribe(params => {
        ...
        this.service.getContratoXID(this.id).subscribe(fun => {
          ...
          this.dias = new Date(this.contratoParams.fecha_Pago).getDate()+1;
